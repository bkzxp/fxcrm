<?php /*a:2:{s:64:"E:\wamp64\wamp64\www\cms\application\admin\view\index\index.html";i:1536744971;s:59:"E:\wamp64\wamp64\www\cms\application\admin\view\layout.html";i:1536904468;}*/ ?>
<!DOCTYPE html>
<html>
...
<body class="layui-layout-body">
    <div class="layui-layout layui-layout-admin">
        <div class="layui-header">
            ...
            <ul class="layui-nav layui-layout-right">
                <li class="layui-nav-item"><a href="javascript:;"><?php echo htmlentities($userInfo['username']); ?></a>
                    <dl class="layui-nav-child">
                        <dd><a href="<?php echo url('admin/login/logout'); ?>">安全退出</a></dd>
                    </dl>
                </li>
            </ul>
        </div>
    ...
    layui.use(['element', 'layer', 'jquery'], function() {
        ...
        $.each(SUBMENU_CONFIG, function(i, o) {
            html.push('<li class="layui-nav-item"><a href="javascript:;" title="' + o.title + '" lay-id="' + o.id + '">' + o.title + '</a></li>');
        });
                ...
                for (var attr in data) {
                    if (data[attr] && typeof(data[attr]) === 'object') {
                        ...
                        if (attr === 'title') {
                            ...
                            if (!(data['isChild'])) {
                                //一级菜单
                                html.push('<li class="layui-nav-item"><a href="' + data.url + '" lay-id="' + data.id + '"><b>' + data.title + '</b></a>');
                            } else {
                                //二级菜单
                                child_html.push('<dd><a href="' + data.url + '" lay-id="' + data.id + '">' + data.title + '</a></dd>');
                                //二级菜单全部push完毕
