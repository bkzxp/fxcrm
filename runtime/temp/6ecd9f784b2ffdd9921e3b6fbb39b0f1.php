<?php /*a:1:{s:64:"E:\wamp64\wamp64\www\cms\application\admin\view\login\index.html";i:1536903864;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div id="mydiv">
        <div class="login-main">
            <div class="layui-elip">管理系统&nbsp;<span class="version">v1.0.0</span></div>
            <form class="layui-form" action="<?php echo url('admin/login/index'); ?>">
